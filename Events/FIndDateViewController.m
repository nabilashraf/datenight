...
#import "FIndDateViewController.h"
...
@interface FIndDateViewController (){
...
@implementation FIndDateViewController
...
//    var destViewController : UIViewController = mainStoryboard.instantiateViewController(withIdentifier: "HomeViewController")
    ...
    [self performSegueWithIdentifier:@"closeFindDate" sender:self];
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier:@"findDateToDetail" sender:self];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if([segue.identifier isEqual: @"findDateToDetail"])
    {
