...
- (void)layoutSubviews;
{
    ...
    if (iOSVersion >= 7) {
        ...
        paragraphStyle.lineBreakMode = self.activityLabel.lineBreakMode;
        
        textSize = [self.activityLabel.text sizeWithAttributes:@{NSFontAttributeName: [UIFont boldSystemFontOfSize:[UIFont systemFontSize]], NSParagraphStyleAttributeName: paragraphStyle}];
    }
    else{
        CGSize maxSize = CGSizeMake(260, 400);
        textSize = [self.activityLabel.text sizeWithFont:[UIFont boldSystemFontOfSize:[UIFont systemFontSize]] constrainedToSize:maxSize lineBreakMode:self.activityLabel.lineBreakMode];
    }
