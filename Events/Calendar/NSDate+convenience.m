...
-(int)year {
    ...
    return (uint32_t)[components year];
}
...
-(int)month {
    ...
    return (uint32_t)[components month];
}
...
-(int)day {
    ...
    return (uint32_t)[components day];
}
...
-(int)firstWeekDayInMonth {
    ...
    return (uint32_t)[gregorian ordinalityOfUnit:NSWeekdayCalendarUnit inUnit:NSWeekCalendarUnit forDate:newDate];
}
...
-(int)numDaysInMonth {
    ...
    return (uint32_t)numberOfDaysInMonth;
}
